...
class KrDomestic4401ExecutionModel:
    def __init__(
        self,
        tag_prefix: str = "kr-domestic-4401",
...
def create_execution_model(params):
    return KrDomestic4401ExecutionModel(
        tag_prefix=str(params.get("tag_prefix", "kr-domestic-4401")),
